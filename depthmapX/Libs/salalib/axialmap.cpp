...
#include <sala/mgraph.h> // purely for the version info --- as phased out should replace
#include <sala/axialmap.h>

#include <sala/pointdata.h>   // need the pointdata for the convert boundary graph to axial map routine
#include <sala/ngraph.h>      // ditto ngraph
